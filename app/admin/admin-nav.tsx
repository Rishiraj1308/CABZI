          ...
          <NavigationMenuList>
              ...
              <NavigationMenuItem>
               ...
               <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                       <ul className="grid w-full gap-3 p-4 md:w-[600px] md:grid-cols-2 lg:w-[700px] min-w-[500px]">
                          {navItems.management.map((item) => (
                             <ListItem key={item.title} title={item.title} href={item.href} icon={item.icon}>
                               {item.description}
                             </ListItem>
              ...
              <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                       <ul className="grid w-full gap-3 p-4 md:grid-cols-2 md:min-w-[500px] lg:w-[600px]">
                          {navItems.growth.map((item) => (
                             <ListItem key={item.title} title={item.title} href={item.href} icon={item.icon}>
                               {item.description}
                             </ListItem>
