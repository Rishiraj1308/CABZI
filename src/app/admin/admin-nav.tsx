...
import {
  ...
  Gem, Ambulance, Wrench, CalendarCheck
} from 'lucide-react'
...
const navItems = {
  ...
  management: [
    ...
    { title: "Customers", href: "/admin/customers", description: "View all registered riders.", icon: Users },
    ...
    { title: "Appointments Log", href: "/admin/appointments", description: "Track booked doctor appointments.", icon: CalendarCheck },
  ],
  financial: [
    { title: "Cabzi Bank", href: "/admin/bank", description: "Monitor the financial engine and loans.", icon: Landmark },
