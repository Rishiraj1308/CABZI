...
export default function AdminTeamPage() {
  ...
  const handleAddMember = (e: React.FormEvent) => {
    ...
    if (!newAdminName || !newAdminEmail || !newAdminRole || !newAdminSalary) {
        toast({ variant: 'destructive', title: 'Missing Fields', description: 'Please fill out all fields to add a new member.' });
        return;
    }

    if (!canAddRole(newAdminRole)) {
        toast({ variant: 'destructive', title: 'Permission Denied', description: "You don't have permission to add a member with this role." });
        return;
    }
