  ...
  const handleLogout = async () => {
    ...
    if(sessionString && db) {
        try {
            ...
            if(partnerId) {
                // We need to find the driver document by its custom driverId, not the doc id
                // This part of the logic needs to be revisited if we want to update isLoggedIn status on logout
            }
        } catch (error) {
