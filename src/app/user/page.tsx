...
export default function ServicePortalPage() {
  ...
  const serviceData = React.useMemo(() => [
    { id: 'ride', href: '#', onClick: () => toast({ title: 'Coming Soon!', description: 'The ride-hailing feature is temporarily disabled.' }), icon: Car, title: 'Ride', description: 'Fair fares for your daily commute.', tag: '5–10m', tagIcon: Clock, iconBg: 'bg-emerald-400/15', iconRing: 'ring-emerald-400/30', iconColor: 'text-emerald-500', tagBg: 'bg-emerald-400/10', tagBorder: 'border-emerald-400/30', tagColor: 'text-emerald-600', label: 'ride transport car taxi clinic mobility hospital cab गाड़ी कार टैक्सी', glowColor: 'hsl(145, 63%, 49%)' },
  ...
  const handleServiceClick = (service: any) => {
    if (service.onClick) {
      ...
      if (service.href === '#') {
        toast({ title: 'Coming Soon!', description: 'This feature is temporarily disabled.' });
      } else {
