...
export default function DriverLayout({
  ...
  const handleLogout = async () => {
    if (partnerDocRef.current) {
        try {
            // This is a "fire and forget" update. We don't wait for it.
            updateDoc(partnerDocRef.current, { isOnline: false, lastSeen: serverTimestamp(), isLoggedIn: false, lastLoginDevice: null, lastLoginTimestamp: null });
        } catch (error) {
