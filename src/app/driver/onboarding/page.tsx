    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await addDoc(collection(db, "partners"), {
                partnerId, curocityBankAccountNumber, name, phone, gender, dob, panCard, 
                ...
                return (
                     <div className="space-y-6">
                        ...
                        <div className="mt-6 flex items-center space-x-2">
                            <Checkbox id="curocity-pink" name="curocity-pink" checked={isCurocityPink} onCheckedChange={(checked) => setIsCurocityPink(checked as boolean)} disabled={formData.gender !== 'female'} />
