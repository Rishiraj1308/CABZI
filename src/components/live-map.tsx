...
const LiveMap = forwardRef<any, LiveMapProps>((props, ref) => {
    ...
    }, [props.riderLocation, props.isTripInProgress]);
    ...
    useEffect(() => {
        ...
        if (props.driverLocation && typeof props.driverLocation.lat === 'number' && typeof props.driverLocation.lon === 'number') {
            ...
            const iconType = props.activePartners?.find(p => p.location.lat === lat && p.location.lon === lon)?.type || 'driver';
    ...
    }, [props.driverLocation, props.activePartners, props.isTripInProgress, startAnimationLoop]);
