    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text: `I'm on a Curocity ride with ${ride.driverDetails?.name || 'a driver'}. Vehicle: ${ride.driverDetails?.vehicle} (${ride.vehicleNumber}).`,
        });
      ...
      <Card className="rounded-t-2xl -mt-4 z-10 flex-shrink-0 border-t-4 border-primary/20">
        <CardContent className="p-4 space-y-4">
            ...
            <div className="flex gap-4">
                ...
                <Button className="flex-1 h-12" onClick={handleShareRide}>
