...
export default function ResQPage() {
  ...
  if (activeGarageRequest) {
    const mockRideData = {
        ...activeGarageRequest,
        driverDetails: {
            name: activeGarageRequest.mechanicName || "Mechanic",
            vehicle: "Service Bike",
            rating: 4.9,
            photoUrl: `https://i.pravatar.cc/150?u=${activeGarageRequest.mechanicId}`,
            phone: activeGarageRequest.mechanicPhone || ''
        },
        pickup: {
            address: activeGarageRequest.locationAddress || "Your location",
            location: activeGarageRequest.location
        },
    }
    return (
        <div className="h-full w-full flex items-center justify-center p-4">
            <DriverArriving ride={mockRideData as any} onCancel={handleCancelServiceRequest} />
        </div>
    )
  }
